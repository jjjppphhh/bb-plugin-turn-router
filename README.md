...
- Before that family is established, model and reasoning form a capability coordinate: Luna, Terra, and Sol are family steps 1–3, while Low through Ultra are substeps 1–6 (`Sol Ultra` is `5.6.3.6`). An automatic family change must move more than five substeps; smaller recommendations change reasoning within the current family instead. Cross-generation recommendations remain eligible.
